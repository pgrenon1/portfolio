(function () {
	...
	// Integrating ajax with the homepage
	document.addEventListener('DOMContentLoaded', () => { // () => {} is the same as function () {}
		const links = document.querySelectorAll('.menu-item'); // an array of all matching elements (CSS selector)

		Barba.Pjax.init(); // we need to link these (Barba lib)
		Barba.Prefetch.init();
	...
	// gonna listen for a page load event ^
